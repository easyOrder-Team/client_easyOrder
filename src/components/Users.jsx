...
export const Users = () => {
  ...
  const showDiv = (profile)=>{
    let element =  window.document.getElementById(`divInfo${profile.id_profile}`)
            ...
            {profiles.map((profile) => {
              return (
                <div className={users.globalContainerConDiv}>
                  ...
                  <div  id={`divInfo${profile.id_profile}`} className={users.divInfo}>
                    <select name="superadmin" id="" value={data.superadmin}  onChange={(e) => handleInputChange(e)}>
                      <option value="true">Admin</option>
                      <option value="false">Usuario</option>
                    </select>
                    <select name="state" id="" value={data.state}  onChange={(e) => handleInputChange(e)}>
                      <option value="true">Activo</option>
                      <option value="false">Inactivo</option>
                    </select>
                    <button className={users.btnAceptar} onClick={()=>updateUser(profile.id_profile)}>Aceptar</button>
                  </div>
                </div>
              );
            })}
